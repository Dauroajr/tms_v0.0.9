...
class Tenant(models.Model):
    ...
    def add_number(self, user, role='user', is_owner=False, invited_by=None):
...
class TenantInvitation(models.Model):
    ...
    def is_valid(self):
        ...
        return (
            self.accepted_at is None and self.expires_at > timezone.now()
        )
    ...
    def accept(self, user):
        ...
        return TenantUser.ibjects.create(
            user=user,
            tenant=self.tenant,
            role=self.role,
